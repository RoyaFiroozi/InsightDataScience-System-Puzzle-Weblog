...
def callback(ch, method, properties, body):
    msg = json.loads(body)
#    print("SOURCEEEEEEEEEEEEEE: ", body)
    values = "\'" + msg['source'] + "\', " + "to_date(\'" + msg['day'] + "\', \'YYYY-MM-DD\')" + ", " + msg['status']
    sql = """INSERT INTO weblogs (source, day, status) VALUES (%s);""" % values
#    print("VALUEEEEEEEEEEEEEE: ", values)
